    ...
    >
      ...
      >
        ...
        <div className="p-5 grid grid-cols-3 gap-3 mb-4">
          {[
            { icon: Users, label: t('hall.capacity'), value: `${hall.capacity} ${t('common.persons')}` },
            { icon: Clock, label: t('hall.hours'), value: hall.hours },
            {
              icon: CreditCard,
              label: t('hall.pricePerHour'),
          ...
          <div className="px-5 pb-5 flex gap-3">
            {onToggleFavorite && (
              ...
              >
                ...
                />
                {isFavorite ? t('hall.inFavorites') : t('hall.addToFavorites')}
              </button>
            )}
            {onBook && (
              <button
