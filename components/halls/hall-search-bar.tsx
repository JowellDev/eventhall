...
const CAPACITY_OPTIONS_VALUES = [null, 100, 200, 350, 500]
const PRICE_OPTIONS_VALUES = [null, 85000, 120000, 150000]
...
export function HallSearchBar({
  ...
  const SORT_OPTIONS: { label: string; value: HallFilters['sortBy'] }[] = [
    { label: t('search.relevance'), value: 'default' },
    { label: t('search.bestRated'), value: 'rating' },
    { label: t('search.priceAsc'), value: 'price_asc' },
    { label: t('search.priceDesc'), value: 'price_desc' },
    { label: t('search.capacityDesc'), value: 'capacity' },
  ]
              ...
              <div className="flex flex-wrap gap-2">
                {CAPACITY_OPTIONS.map(opt => (
                  <button
                    ...
                    style={
                      filters.minCapacity === opt.value ? CHIP_ACTIVE : CHIP_IDLE
                    }
                  >
                    {opt.label}
                  </button>
