      ...
      >
        ...
        >
          ...
          <h3 className="font-display font-bold text-xl text-foreground mb-2">
            {t('reservations.modifySaved')}
          </h3>
          <p className="text-muted-foreground text-sm font-body mb-6">
            {t('reservations.modifySavedDesc')}
          </p>
          <button
            onClick={onClose}
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-display text-lg font-bold text-foreground">
                {t('reservations.modifyTitle')} — {booking.hallName}
              </h2>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex justify-between text-sm font-body">
                  <span className="text-muted-foreground">{t('reservations.hall')}</span>
                ...
                <div className="flex justify-between text-sm font-body">
                  <span className="text-muted-foreground">{t('reservations.schedules')}</span>
                  <span className="text-foreground font-medium">
                    {startTime} – {endTime}
                  </span>
                </div>
              ...
              >
                {t('reservations.confirmModification')}
              </button>
            </div>
          )}
        </div>
    ...
    >
      ...
      >
        ...
        <p className="text-muted-foreground text-sm font-body text-center mb-6">
          {t('reservations.cancelDescPre')}{' '}
          <strong className="text-foreground">{booking.hallName}</strong>{' '}
          {t('reservations.cancelDescMid')}{' '}
          <strong className="text-foreground">{booking.date}</strong>
          {t('reservations.cancelDescPost')}
        </p>
...
export function ClientReservations({ onClose }: ClientReservationsProps) {
  ...
  const filtered = bookings.filter(b => {
    ...
    if (filter === 'cancelled')
      return b.status === 'cancelled' || b.status === 'refused'
                    ...
                    <div>
                      ...
                      {booking.packages.length > 0 && (
                        <p className="text-xs text-muted-foreground font-body mt-1">
                          {t('reservations.options')} {booking.packages.join(', ')}
                        </p>
                      )}
                    </div>
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      {canModify(booking.status) && (
                        ...
                        >
                          <Pencil className="w-3.5 h-3.5" /> {t('reservations.modify')}
                        </button>
                      )}
                      {canCancel(booking.status) && (
                        ...
                        >
                          <XCircle className="w-3.5 h-3.5" /> {t('reservations.cancel')}
                        </button>
                      )}
                    </div>
                  </div>
