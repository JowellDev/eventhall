    ...
    >
      ...
      >
        <div className="max-w-2xl mx-auto flex items-center gap-3">
          ...
          />
          {query && (
            <button onClick={() => setQuery('')} className="p-1 rounded-lg hover:bg-surface-raised transition-colors">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          {results.length === 0 ? (
            <div className="text-center py-16">
              <p className="font-display font-semibold text-foreground mb-1">Aucun résultat</p>
            ...
            <div className="space-y-3">
              {results.map((hall) => (
                ...
                >
                  ...
                  <p className="font-display text-sm font-bold flex-shrink-0" style={{ color: '#d4af37' }}>
