...
import { SettingsToggles } from '@/components/shared/settings-toggles'
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {isAuthenticated && (
            <>
              <button
                ...
                aria-label={t('client.myReservations')}
              >
          ...
          {dashboardHref && (
            ...
            >
              ...
              <span className="hidden sm:inline">{t('client.mySpace')}</span>
            </Link>
          )}
          ...
          {isAuthenticated ? (
            ...
            >
              ...
              <span className="hidden sm:inline">{t('client.login')}</span>
            </button>
          )}
        </div>
      </div>
