...
const MOCK_NOTIFICATIONS: Notification[] = [
  {
    ...
    message: 'Votre réservation à Villa Lumière le 18/05 a été confirmée par le propriétaire.',
    time: 'Il y a 2h',
    read: false,
  },
  {
  ...
  },
  {
    ...
    message: "Rappel : votre événement à Espace Royal est dans 2 jours. Pensez à confirmer les détails.",
    time: 'Hier',
    read: true,
  },
]
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          {notifications.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center py-16">
              ...
              >
                <Bell className="w-8 h-8" style={{ color: 'rgba(212,175,55,0.3)' }} />
              </div>
              <p className="text-muted-foreground font-body text-sm">Aucune notification</p>
            </div>
          ) : (
            notifications.map((notif) => {
              ...
              return (
                <button
                  ...
                  style={{
                    background: notif.read ? 'transparent' : 'rgba(212,175,55,0.04)',
                    borderColor: notif.read ? 'rgba(212,175,55,0.08)' : 'rgba(212,175,55,0.18)',
                  }}
                >
                  <div
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-0.5">
                      <p className="font-body text-sm font-semibold text-foreground">{notif.title}</p>
                      {!notif.read && (
                        <span
                    ...
                    <p className="font-body text-xs mt-1.5" style={{ color: 'rgba(212,175,55,0.6)' }}>
                      {notif.time}
                    </p>
                  </div>
                </button>
