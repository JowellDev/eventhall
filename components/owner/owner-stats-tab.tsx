...
export function OwnerStatsTab() {
  return (
    <div className="space-y-6">
      <h2 className="font-display text-xl font-semibold text-foreground">Statistiques</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {halls.map((hall) => (
          <div
            ...
            style={{ background: '#1a1a1a', borderColor: 'rgba(212,175,55,0.12)' }}
          >
            <h3 className="font-display text-sm font-bold text-foreground mb-3">{hall.name}</h3>
