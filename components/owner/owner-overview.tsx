  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {recentActivity.map((item, i) => (
            <li key={i} className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground font-body mt-0.5">{item.time}</p>
              </div>
            </li>
          ))}
        </ul>
      ...
      <div
        ...
        style={{ background: '#1a1a1a', borderColor: 'rgba(212,175,55,0.12)' }}
      >
        <h2 className="font-display text-base font-semibold text-foreground mb-4">Top Salles</h2>
          ...
          {halls.map((hall, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <p className="font-body text-sm font-semibold text-foreground">{hall.name}</p>
