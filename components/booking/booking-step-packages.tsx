...
export function BookingStepPackages({ data, onTogglePackage, onNext }: BookingStepPackagesProps) {
  return (
          ...
          return (
            <button
              ...
              style={{
                ...
                borderColor: isSelected ? 'rgba(212,175,55,0.5)' : 'rgba(212,175,55,0.12)',
              }}
            ...
            >
              ...
              >
                <Package className="w-4 h-4" style={{ color: isSelected ? '#0a0a0a' : '#d4af37' }} />
              </div>
              <div className="flex-1">
                <p
                  className="text-sm font-semibold font-body"
                  style={{ color: isSelected ? '#d4af37' : 'var(--foreground)' }}
                >
                  {pkg.label}
                </p>
